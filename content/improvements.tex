...
Administration of the Bulletin table presented in \Cref{subsec:impr-database} has also been added using the Flask-Admin module. Administration of bulletins is shown in Figure \ref{fig:admin-bulletin}, which show how to create bulletins and how to view stored database bulletins.
