...
This section will present figures of the views in the frontend that have changed in the version two of the system. Appendix \ref{apdx:screenshots} shows screenshots of the version one and two of the system frontend for comparison. The below sub-sections will explain the improvements and updates done to the listed views. The other views in the system are not listed here as their functionality nor appearance has changed drastically but have rather been changed to keep the views’ styling consistent throughout the system.

\begin{figure}[t!]
    \centering
    \includegraphics[width=0.75\textwidth]{figs/new_homepage.jpg}
    \caption[The updated leader view]{The updated home page view.}
