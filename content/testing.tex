...
\begin{table}[h!]
    ...
    \begin{tabular}{c c c c}
      ...
      \textit{config/} & 1 & 1 & 100.00\% \\
      \textit{controllers/} & 759 & 676 & 89.06\% \\
      \textit{directives/} & 78 & 9 & 11.54\% \\
      \textit{services/} & 33 & 19 & 57.58\% \\ \hline
      \textbf{Total} & 871 & 705 & 80.94\% \\ \hline
    \end{tabular}
    \caption{Frontend total test coverage}
    \label{tab:frontend-coverage-all}
\end{table}

Table \ref{} shows the coverage of all files for the frontend code. Developed using jasmine, generated using karma + gulp as be Follan and støa.
...
\subsection{Server}
Table \ref{} shows the unit test coverage for the server code. The

Does not cover socketio events, but only contains functionality of other imported and installed modules.
...
\begin{table}[h!]
    ...
    \begin{tabular}{c c c c}
      ...
      \textit{routes.submissions} & 150 & 1 & 91\% \\
