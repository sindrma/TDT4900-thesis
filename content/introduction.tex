...
\paragraph*{U2} Improve and extend the CMB system's usability features in accordance with the CMB team's priorities. The features prioritized by the CMB team, is a combination of some features listed in Appendix \ref{apdx:backlog}, previous user feedback, as well needed usability features found throughout the semester:
  \begin{itemize}
...
\begin{table}[t!]
    ...
    \texttt{U1} & Fix the main bugs and known issues found during user testing of \gls{cmb}. & \Cref{sub-sec:impr-frontend-bug} and \ref{sec:impr-backend} \\
